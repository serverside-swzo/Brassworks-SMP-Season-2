...
ServerEvents.tags('item', event => {
    event.add('forge:hidden', [
        ...
        'createqol:shadow_radiance_chestplate{"create:banktank_air":900}',
        'createqol:shadow_radiance_leggings',
        'createqol:shadow_radiance_boots',
        'createqol:refined_radiance_chestplate{"create:banktank_air":900}',
        'createqol:shadow_steel_chestplate{"create:banktank_air":900}',
